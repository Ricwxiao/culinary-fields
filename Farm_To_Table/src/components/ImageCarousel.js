  ...
  return (
    <div className="image-carousel-container" style={{ height: height, width: width }}>
      <div className="left-panel">
        ...
        <NavLink to="/spotlight" className="nav-link">
          <SpotlightImageBox src={spotlightImg} alt="farmer spotlight" width="600px" height="500px" text="Story by Tian Tian Farm: Farming for the Asian Community" text2="Most Liked"/>
        </NavLink>
