    ...
    <div className="image-carousel-container" style={{ height: height, width: width }}>
      ...
      <div className="right-panel">
        <div className="top-image">
          ...
          <SpotlightImageBox src={bokchoyreceipeImg1} alt="farmer spotlight" width="100%" height="100%" text="Bok Choy in season: Here are some of the most popular recipes" text2="In Season" />
